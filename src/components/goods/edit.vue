        ...
        <el-tabs v-model="activeIndex" @tab-click="tabClick" :tab-position="'left'" :before-leave="tabBeforeLeave">
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品价格（元）" prop="goods_price">
              <el-input v-model="editForm.goods_price" type="number" min="0"></el-input>
            </el-form-item>
            <el-form-item label="商品重量（kg）" prop="goods_weight">
              <el-input v-model="editForm.goods_weight" type="number" min="0"></el-input>
            </el-form-item>
            <el-form-item label="商品数量" prop="goods_number">
              <el-input v-model="editForm.goods_number" type="number" min="0"></el-input>
            </el-form-item>
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <el-button type="primary" @click="edit" class="btnAdd">编辑完成</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-card>
...
export default {
  ...
  methods: {
    getGoodsId() {
      ...
      this.goods_id = location.href.slice(i)
    },
    ...
    //确保级联选择器选择的是三级分类
    handleChange() {
      if (this.editForm.goods_cat.length !== 3) return (this.editForm.goods_cat = [])
    ...
    handleRemove(file) {
      ...
      const i = this.editForm.pics.findIndex(val => val.pic === filePath)
    ...
    edit() {
      this.$refs.editFormRef.validate(async valid => {
        ...
        //将editForm深拷贝给一个新对象form而不是直接修改editForm,因为级联选择器绑定的goods_cat需要数组数据，
